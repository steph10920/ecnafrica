    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-700">
          Contact us at <strong>elimu.communitynetwork@gmail.com</strong> or visit <a href="https://www.facebook.com/elimucommunitynetwork/" className="text-blue-600 underline">our Facebook page</a>.
        </p>
      </main>
