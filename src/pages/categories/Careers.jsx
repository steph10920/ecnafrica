      ...
      <section className="py-20 px-6 bg-green-50 border-t border-gray-200">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="mailto:education@ecnafrica.org?subject=Volunteer – [Position Name] – [Your Full Name]" className="bg-white text-green-700 font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-green-50 transition">Volunteer Today</a>
