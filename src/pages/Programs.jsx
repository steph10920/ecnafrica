  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-white via-green-50 to-green-100">
      <div className="flex-grow flex flex-col items-center justify-start px-4 sm:px-8 py-14">
        ...
        >
          Discover how ECN empowers communities through education,
          sustainability, and youth-driven innovation.
        </motion.p>
        ...
        >
          {programs.map((program, index) => (
            <motion.div
              ...
              className={`rounded-3xl bg-gradient-to-br ${program.color} p-6 sm:p-8 flex flex-col items-center text-center relative overflow-hidden`}
            >
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-green-800 mb-3 z-10">
                {program.title}
              </h2>
