        ...
        style={{
          filter:
            i === currentIndex ? "brightness(0.7)" : "brightness(0.65)",
        }}
        loading="lazy"
        />
        ))}
        ...
        <p>
          ...
          communities to create inclusive, practical and sustainable learning
          opportunities.
        </p>
        </div>
        </motion.div>
        ...
        <h2
          id="about-heading"
          className="text-2xl md:text-3xl font-extrabold text-green-800"
        >
          Who We Are
        </h2>
        <p className="text-gray-700 leading-relaxed">
          Elimu Community Network (ECN) is an African-led organization founded
          in Kenya (2012), working to expand quality, contextual and inclusive
          education that empowers learners, teachers and communities. Our model
          blends practical learning, digital skills, and community-led solutions
